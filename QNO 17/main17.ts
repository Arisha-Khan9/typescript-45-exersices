...
let dontcome2 = guestlist2[3];
console.log(`${dontcome2}, is not coming.`);
...
guestlist2.forEach(guests => console.log(`HEY ${guests}, lets catchup over a delicious dinner at our place!`))

// print a msg that the bigger dinner table wont aarive at time!
console.log(`HEY! ${guestlist2}, I want to tell you that the bigger dinner table won't arrive at time and I have space for only 2 friends.`)

// removed friends until the 2 friends left here
while(guestlist2.length > 2) {
    let removedfriends = guestlist2.pop()
    console.log(`sorry! ${removedfriends}, i cant inviting you for dinner`)
}

//print a mesg for those who are left in the list
guestlist2.forEach(twofriends => console.log(`HEY ${twofriends}, luckly! you are still inviting for dinner!`))
